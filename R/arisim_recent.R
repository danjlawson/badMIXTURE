...
#' @title Ari-like Simulated genetic data for the Recent Admixture Scenario
#'
#' @description
...
#' 
#' This simulation follows the so-called "Recent Admixture" scenario, in which the truth is that the "Ari Blacksmiths" (Population 13) are the best representatives of the ancestral population, whilst the "Ari Cultivators" (population 5) are admixed. The mixture solution (\code{arisim_recent$mix} produced with ADMIXTURE, Alexander, Novembre & Lange 2009, Genome Research 19:1655-1664) gets this wrong but the residual plots (\code{arisim_recent$data} produced with ChromoPainter, Lawson, Hellenthal, Myers & Falush 2012, PLoS Genetics, e1002453)  highlight this.
#'
#' See \code{\link{compareMixtureToData}}) and the examples within for how to understand this data.
#' 
#' @format arisim_recent contains the following items:
#' \itemize{
